...
//https://csharp.hotexamples.com/examples/-/SortedDictionary/ToWebString/php-sorteddictionary-towebstring-method-examples.html
...
namespace erTw.Twitter.Lib {
    public class Twitter {
        ...
        public Twitter(string consumerKey, string consumerKeySecret,
        ...
        public string GetTweetsTimeline(string screenName, int count) {
            string resourceUrl =
            ...
            string response = GetResponse(resourceUrl, Method.GET, requestParameters);

            return response;
        }

        public string GetTweetsHome(string screenName, int count) {
            string resourceUrl =
        ...
        private string GetResponse(string resourceUrl, Method method,
